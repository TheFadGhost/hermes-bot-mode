...
function Composer({ entry, agents, draft, onDraft, onSend, onStop, onDictate, isSending, isStopping, attachments, onAttach, onRemoveAttachment, uploading, mentionIds, onMentionIds, replyTo, onClearReply, error, onRetry, actions, onAction }: {
  ...
  return <div className="grok-composer-wrap">
    ...
    <div className="grok-composer">
      ...
      <button className="grok-composer-button grok-mic-button" type="button" aria-label="Open dictation" title="Dictate" disabled={!entry || entry.archived || isSending} onClick={onDictate}><Mic size={18} /></button>
